...
class SuratEksternal extends CI_Model {
    ...
    function get_surat_destinasi($table,$data=array()){
        ...
        $this->db->join('jenis_surat','jenis_surat.id_jenis = surat_eksternal.id_jenis','left');
        $this->db->join('prioritas_surat','prioritas_surat.id_prioritas = surat_eksternal.id_prioritas','left');
        $this->db->join('sifat_surat','sifat_surat.id_sifat = surat_eksternal.id_sifat','left');
         $this->db->join('media_surat','media_surat.id_media = surat_eksternal.id_media','left');
