...
class PrioritasDataModel extends CI_Model
{
    var $table = 'prioritas_surat';
    var $column = array('id_prioritas', 'nama_prioritas', 'keterangan');
    var $order = array('id_prioritas' => 'desc');
