...
class PegawaiDataModel extends CI_Model
{
    var $table = 'pegawai';
    var $column = array('id_pegawai', 'nama_pegawai', 'kontak_email', 'kontak_telepon', 'id_unit', 'id_jabatan');
    ...
    {
        $this->db->select("{$this->table}.*, unit_kerja.id_unit,unit_kerja.nama_unit, jabatan.id_jabatan, jabatan.nama_jabatan");
