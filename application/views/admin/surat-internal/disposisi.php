                            ...
                            <tbody>
                                ...
                                foreach ($set as $row) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?= anchor('disposisi_internal/print/' . $row->id_disposisi_internal, '<button class="btn btn-warning"><i class="fa fa-print"></i> Print</button>', array('target', '_BLANK')); ?>
                                            <button class="btn btn-success" onclick="edit_supplier(<?= $row->id_disposisi_internal; ?>)"><i class="fa fa-edit"></i> Ubah</button>

                                            <?= anchor('disposisi_internal/destroy/' . $row->id_disposisi_internal, '<button class="btn btn-danger"><i class="fa fa-trash"></i> Hapus </button>'); ?>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
...
<script>
    ...
    function edit_supplier(id) {
        ...
        $.ajax({
            url: "<?= base_url('disposisi_internal/get') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
                ...
                $('.modal-footer').show();
                $('#form').attr('action', '<?= site_url('disposisi_internal/update'); ?>');
            },
...
<div id="myModal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <?= form_open('disposisi_internal/create', array('id' => 'form')); ?>
